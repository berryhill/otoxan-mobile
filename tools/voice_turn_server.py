...
def _attach_metrics_record_summary(record: dict[str, Any]) -> None:
    ...
    record["summary"] = {
        ...
        "sttStatus": _nested_get(verdict, "sttStatus"),
        "sttLatencyMs": _nested_get(backend, "sttLatencyMs"),
        "mobileFastSessionFallbackEnabled": _nested_get(backend, "mobileFastSessionFallbackEnabled"),
        "mobileFastSessionFallbackHardTimeoutSeconds": _nested_get(backend, "mobileFastSessionFallbackHardTimeoutSeconds"),
        "mobileFastFailureReason": _nested_get(backend, "mobileFastFailureReason"),
        "xanderFallbackSessionStatus": _nested_get(backend, "xanderFallbackSessionStatus"),
        "xanderFallbackSkipped": _nested_get(backend, "xanderFallbackSkipped"),
        "xanderFallbackTimedOut": _nested_get(backend, "xanderFallbackTimedOut"),
...
def _metrics_history_summary(records: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "latestMobileFastFailureReason": latest.get("mobileFastFailureReason"),
        "latestMobileFastSessionFallbackEnabled": latest.get("mobileFastSessionFallbackEnabled"),
        "latestMobileFastSessionFallbackHardTimeoutSeconds": latest.get("mobileFastSessionFallbackHardTimeoutSeconds"),
        "latestXanderFallbackSessionStatus": latest.get("xanderFallbackSessionStatus"),
        "latestXanderFallbackSkipped": latest.get("xanderFallbackSkipped"),
        "latestXanderFallbackTimedOut": latest.get("xanderFallbackTimedOut"),
        "latestXanderFallbackFailureReason": latest.get("xanderFallbackFailureReason"),
